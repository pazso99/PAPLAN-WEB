...
const { getPackageUnit, updatePackageUnit, deletePackageUnit } = inventoryManagementStore;
...
onMounted(async () => {
    ...
    await getPackageUnit(routeId.value);
    setData();
});
...
function handleDelete() {
    confirm.require({
        ...
        acceptLabel: 'Delete',
        accept: async () => {
            await deletePackageUnit(routeId.value, true);
        },
    });
};
</script>
